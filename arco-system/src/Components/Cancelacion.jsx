        ...
        <div className={classes.blackBack}>
            <section style={{display: "flex", flexDirection: "column", width:"80%", padding: "64px", backgroundColor: "#ffffff", gap: "48px"}}>
                ...
                <section style={{display: "grid", gap:"32px"}}>
                    ...
                    <button style={{display: "flex", maxWidth: "300px", backgroundColor: "#48cd00", fontWeight: "700", color: "#ffffff", fontSize: "18px", padding: "8px", justifySelf: "end", border: "0", cursor: "pointer" }}>Registrar Cancelación</button>
                </section>
            </section>
        </div>
    </Modal>
