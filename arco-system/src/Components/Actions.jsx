...
function Actions() {
  ...
  return (
    <section style={{display: "flex", width: "86%", height: "100vh" , flexDirection: "column", justifyContent: "center", alignItems: "center", position: "absolute", marginTop: "4px", zIndex: "9999", background: "rgba(0, 0, 0, .5)"}}>
        <section style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", gap: "50px" ,width: "80%",backgroundColor: "#ffffff", padding: "50px"}}>
            ...
            <div className={classes.DDOption}>
                <Button variant="contained">Oposición</Button>
