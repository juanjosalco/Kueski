...
const useStyles = makeStyles((theme) => ({
  ...
  // @apply w-[30px] h-[30px] outline outline-black outline-4 border-0 focus:ring-[#008ad8] appearance-none checked:bg-[#008ad8] cursor-pointer
}));
    ...
    <div className={classes.blackBack}>
        <section style={{display: "flex", flexDirection: "column", width:"80%", padding: "64px", backgroundColor: "#ffffff", gap: "48px"}}>
            <div style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                ...
                <button style={{height: "50px", backgroundColor: "#ffffff", border: "0"}}>
